...
class SemanticDepth(Enum):
    """Processing depth levels for different use cases"""
    FAST = "fast"           # STM: Basic processing, <1ms
    STANDARD = "standard"   # Balanced: Full analysis, ~2-5ms  
    DEEP = "deep"          # LTM: Maximum analysis, ~10-20ms
